...
inline world_t setalive_w(world_t world, int16_t r, int16_t c) {
  BITSETM(world.hash, r + 1, c + 1, WDWD + 2);
  return world;
}

inline world_t setdead_w(world_t world, int16_t r, int16_t c) {
...
bit step_w(world_t world, int16_t r, int16_t c) {
  bit neighbours = mooreneighbours_w(world, r, c);
